...
SERCOMM_TPB23_CellularContext::SERCOMM_TPB23_CellularContext(ATHandler &at, CellularDevice *device, const char *apn, bool cp_req, bool nonip_req) :
...
NetworkStack *SERCOMM_TPB23_CellularContext::get_stack()
{
    ...
    if (!_stack) {
        _stack = new SERCOMM_TPB23_CellularStack(_at, _cid, (nsapi_ip_stack_t)_pdp_type);
    }
    return _stack;
}
